...
parser.add_argument('--C_ckpt', type=str, default='checkpoints/audio2landmark/best_C_v1.pth', help='lr schedule policy')
parser.add_argument('--G_ckpt', type=str, default='checkpoints/audio2landmark/best_G_v1.pth', help='lr schedule policy')
