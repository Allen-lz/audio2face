...
class Direction(nn.Module):
    def __init__(self, motion_dim):
        ...
        self.weight = nn.Parameter(torch.randn(512, motion_dim))  # 这里指的是有motion_dim个运动分量, 每个分量的长度是512
    ...
    def forward(self, input):
        ...
        if input is None:
            ...
            input_diag = torch.diag_embed(input)  # alpha, diagonal matrix  使用一个向量生成一个正方形的对角矩阵
